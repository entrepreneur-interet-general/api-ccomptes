...
$spy.affix(data)})})}(jQuery);(function(global){"use strict";function addEventListener(elem,event,fn){if(elem.addEventListener){return elem.addEventListener(event,fn,false);}
...
return originalPropFn.apply(this,arguments);};}}(jQuery));(function($){"use strict";$(function(){$('[data-toggle="tooltip"]').tooltip();$('[data-toggle="popover"]').popover();});}(window.jQuery));